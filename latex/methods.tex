...
\caption{The scattering between two protons with two gluons colliding and interacting to create a $Z^0$ boson or a photon decaying into a muon-pair. This process is strictly forbidden in ordinary SM, but is allowed in modifications to the SM by NCG theory.} \label{fig:feyn:pp-gg-z-mumu}
\end{figure}
