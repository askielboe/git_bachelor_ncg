...
\end{equation}
The first two terms can be calculate directly in CompHEP, while we take a closer look at the latter. 
...
\end{equation}
Now we are ready to create the cross sections, needed for analysis, with CompHEP. We collide protons with beam energy 7000 GeV and then look at these different processes:
\begin{align}
